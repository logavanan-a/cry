...
class DashBoardData(object):
    ...
    def get_total_beneficiary_for_partner(self, part):
        ...
        bene_tot = bene.filter(beneficiary_type__id=bt,partner=part).distinct()
        boundary_id = []
        for loc in bene_tot:
            boundary_id.append(self.retrieve_village_id(self.convert_into_object(loc.jsondata)['address'][0]))
    ...
    villages_dict = {}
        ...
        for bene_data in beneficiary.keys():
            ...
            bene_mast_loc['others_backgroundColor'] = '#7142f4'
    ...
    #print "master fac ",master_facility
    ...
    def data_dump(self):
        ...
        for user_id, partner_id in users_partners:
            ...
            #print "partner , facility ",partner_id,facility
